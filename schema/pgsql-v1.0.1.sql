...
--
-- Name: geography_columns; Type: VIEW; Schema: public; Owner: scraper
--
...
ALTER TABLE public.geography_columns OWNER TO scraper;

--
-- Name: geometry_columns; Type: VIEW; Schema: public; Owner: scraper
--
...
ALTER TABLE public.geometry_columns OWNER TO scraper;
...
--
-- Name: geometry_columns_delete; Type: RULE; Schema: public; Owner: scraper
--
...
--
-- Name: geometry_columns_insert; Type: RULE; Schema: public; Owner: scraper
--
...
--
-- Name: geometry_columns_update; Type: RULE; Schema: public; Owner: scraper
--
