...
ALTER TABLE ONLY scraper.region DROP CONSTRAINT region_parent_fkeyregion_parent_fkey;
...
DROP INDEX public.api_num_type_date;
...
ALTER TABLE ONLY scraper.region DROP CONSTRAINT region_id;
...
CREATE TABLE "FracFocusReport" (
    ...
    err_field character varying,
    err_comment character varying,
...
CREATE TABLE "WV_DrillingPermit" (
    ...
    permit_type character varying,
    current_operator character varying,
    farm_name character varying,
    well_number character varying,
    permit_activity_type character varying,
    permit_activity_date date,
    utm_north double precision,
    utm_east double precision,
    datum integer,
    county character varying,
    target_formation character varying[] DEFAULT '{}'::character varying[]
);
...
--
-- Name: region_id; Type: CONSTRAINT; Schema: scraper; Owner: scraper; Tablespace: 
--
...
--
-- Name: api_num_type_date; Type: INDEX; Schema: public; Owner: scraper; Tablespace: 
--

CREATE UNIQUE INDEX api_num_type_date ON "WV_DrillingPermit" USING btree ("API", permit_number, permit_activity_type, permit_activity_date);
...
--
-- Name: region_parent_fkeyregion_parent_fkey; Type: FK CONSTRAINT; Schema: scraper; Owner: scraper
--

ALTER TABLE ONLY region
    ADD CONSTRAINT region_parent_fkeyregion_parent_fkey FOREIGN KEY (parent) REFERENCES region(id);
