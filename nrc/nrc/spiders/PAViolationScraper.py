...
#        l.add_value ('Permit_API', row['PERMIT_NUM'])
        l.add_value ('Permit_API', row['API_PERMIT'])
...
#        l.add_value ('PenaltyDateFinal', self.parse_date(row['COMPLETED_DATE']))
        l.add_value ('PenaltyDateFinal', self.parse_date(row['PENALTY_FINAL_DATE']))
#        l.add_value ('EnforcementDateFinal', self.parse_date(row['FINAL_ENFORCEMENT_DATE']))
        l.add_value ('EnforcementDateFinal', self.parse_date(row['ENFORCEMENT_FINAL_DATE']))
