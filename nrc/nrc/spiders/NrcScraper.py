...
#                    callback=self.parse_materials)
                yield item
                self.db.setBotTaskStatus(item['reportnum'], job['job_name'], 'DONE')
...
#                    yield m_request
    ...
    def parse_full_report(self, response):
        ...
        yield item
        self.db.setBotTaskStatus(reportnum, job['job_name'], 'DONE')
